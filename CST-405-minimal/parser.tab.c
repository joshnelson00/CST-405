...
{
       0,    55,    55,    59,    64,    68,    76,    77,    78,    79,
      80,    85,    93,   105,   114,   118,   121,   126,   130,   134,
     138,   142,   148
};
#endif
...
{
      26,    -8,   -11,     1,     6,    -3,    21,    18,   -17,   -17,
     -17,   -17,   -17,     5,     9,    15,     5,   -17,     4,   -17,
     -17,   -17,   -17,     5,    43,   -17,   -17,    27,    35,     5,
       5,     5,     5,   -17,    16,   -17,   -10,   -10,   -17,   -17,
     -17
};
...
{
       0,    10,     0,     0,     0,     0,     0,     0,     4,     6,
       7,     8,     9,     0,     0,     0,     0,     1,    10,     5,
      14,    15,    16,     0,     0,    11,    12,     0,     0,     0,
       0,     0,     0,    13,     0,    21,    17,    18,    19,    20,
      22
};
...
{
      27,    31,    32,    13,    -3,    12,    14,    28,    20,    21,
      22,    15,    16,    36,    37,    38,    39,    12,    -2,    18,
      23,    17,    25,     2,     3,     4,     5,     1,    26,    40,
      19,     2,     3,     4,     5,     0,    29,    30,    31,    32,
       0,     0,     0,    34,    29,    30,    31,    32,     0,     0,
       0,    35,    29,    30,    31,    32,    33
};

static const yytype_int8 yycheck[] =
{
      16,    11,    12,    14,     0,    13,     5,    23,     3,     4,
       5,     5,    15,    29,    30,    31,    32,    13,     0,     1,
      15,     0,    13,     5,     6,     7,     8,     1,    13,    13,
       7,     5,     6,     7,     8,    -1,     9,    10,    11,    12,
      -1,    -1,    -1,    16,     9,    10,    11,    12,    -1,    -1,
      -1,    16,     9,    10,    11,    12,    13
};
...
{
       0,     1,     5,     6,     7,     8,    18,    19,    20,    21,
      22,    24,    13,    14,     5,     5,    15,     0,     1,    20,
       3,     4,     5,    15,    23,    13,    13,    23,    23,     9,
      10,    11,    12,    13,    16,    16,    23,    23,    23,    23,
      13
};
...
#line 1125 "parser.tab.c"
  ...
  case 3: /* program: stmt_list error  */
#line 59 "parser.y"
...
#line 85 "parser.y"
        ...
        addVar((yyvsp[-1].str), TYPE_INT);                    /* Add the INT variable to symbol table */
        /* Create declaration node and free the identifier string */
        (yyval.node) = createDecl((yyvsp[-1].str), TYPE_INT);  /* $2 is the ID token's string value */
        free((yyvsp[-1].str));  
...
#line 1174 "parser.tab.c"
  ...
  case 12: /* decl: FLOAT ID ';'  */
#line 93 "parser.y"
                   { 
        /* Add variable to symbol table before freeing the string */
        addVar((yyvsp[-1].str), TYPE_FLOAT); /* Add the FLOAT variable to symbol table */
        /* Create declaration node and free the identifier string */
        (yyval.node) = createDecl((yyvsp[-1].str), TYPE_FLOAT); /* $2 is the ID token's string value */
...
#line 118 "parser.y"
          { 
        (yyval.node) = createFlt((yyvsp[0].num));  // Add float literal handling
    }
